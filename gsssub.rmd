...
This time compare the opinion on death penalty (CAPPUN) with whether or not you won a gun (OWNGUN)
...
<!--Numerical results go here. Use the numerical results to describe the patterns if any that exist in the data as focused toward the research question!-->
Get row percents and column percents 
```{r} 
...
$H_0$ : there is no relationship between owning a gun and opinion on the death penalty  

$H_a$ : gun ownership and opinion on capitol punishment are related  
